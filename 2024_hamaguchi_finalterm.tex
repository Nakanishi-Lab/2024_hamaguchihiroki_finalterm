...
\begin{figure*}[t]
  \centering
  \subfigure[長節-腕節間の動作実験]{\includegraphics[scale=0.23]{image/chousetu-wansetu_edited.png}}\\
  \label{fig:move1}
  \vspace{-2mm}
  \subfigure[腕節‐前節間の動作実験]{\includegraphics[scale=0.23]{image/wansetu-zensetu_edited.png}}
  \label{fig:move2} 
  \vspace{-2mm}
  \subfigure[前節‐指節間の動作実験]{\includegraphics[scale=0.23]{image/zensetu-sisetu_edited.png}}
  \label{fig:move3} 
  \vspace{-2mm}
