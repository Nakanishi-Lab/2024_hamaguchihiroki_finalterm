...
\begin{figure}[!t]
  \begin{minipage}[b]{0.47\columnwidth}
    \centering
    \includegraphics[scale=0.1]{image/hikaku.png}
    \vspace{-2mm}
    \caption{MPA締結方法}
    \label{fig:OringMPA}
  \end{minipage}
  \begin{minipage}[b]{0.5\columnwidth}
    \centering
    \includegraphics[scale=0.05]{image/MPA_irast.jpg}
    \vspace{-2mm}
    \caption{細径MPA部品}
    \label{fig:MPAparts}
  \end{minipage}
...
\begin{table}[t]
  ...
  \scalebox{0.58}{ 
      \begin{tabular}{|c|c|c|c|}
          ...
          計算上のロボットの可動域　& 49.4$\sim$130.6 & 0$\sim$27 & 0$\sim$32.35 \\ \hline
...
\begin{figure}[t]
  ...
  \label{fig:move1} \includegraphics[scale=0.2]{image/chousetu-wansetu_edited.png}}
  \vspace{-2mm}
  \centering
  \subfigure[腕節‐前節間の動作実験]{
  \label{fig:move2} \includegraphics[scale=0.2]{image/wansetu-zensetu_edited.png}}
  \vspace{-2mm}
  \centering
  \subfigure[前節‐指節間の動作実験]{
  \label{fig:move3} \includegraphics[scale=0.2]{image/zensetu-sisetu_edited.png}}
  \vspace{-2mm}
  \caption{動作実験の様子}
  \label{fig:jikken}
  \vspace{-2mm}
